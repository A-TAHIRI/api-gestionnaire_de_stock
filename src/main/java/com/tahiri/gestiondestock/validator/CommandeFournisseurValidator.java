...
public class CommandeFournisseurValidator {
    public static  List<String> validate(CommandeFournisseur commandeFournisseur){
        ...
        if (!StringUtils.hasLength(commandeFournisseur.getReference())) {
            errors.add("Veuillez renseigner le code de la commande");
        }
        if (commandeFournisseur.getDateCommande() == null) {
            errors.add("Veuillez renseigner la date de la commande");
        }
        if (!StringUtils.hasLength(commandeFournisseur.getEtatCommande().toString())) {
            errors.add("Veuillez renseigner l'etat de la commande");
        }
